            ...
            <div class="col-12 p-4">
                <?php if (!isset($_POST["titulo"])) : ?>
                    ...
                    <form action="" method="POST">
                        ...
                        <input class="mb-2 mt-2 w-50" type="text" name="img_desktop" require placeholder="Imagem para Desktop">
                        <br>

                        <input class="mb-2 w-50" type="text" name="img_mobile" require placeholder="Imagem para Mobile">
                        <br>

                        <input class="mb-2 w-50" type="text" name="titulo" require placeholder="Título">
                        <br>

                        <input class="mb-2 w-50" type="text" name="observacao" require placeholder="Observação">
                        <br>

                        <textarea class="mb-2 w-50" maxlength="10" id="texto" name="texto" require placeholder="Texto do Banner"></textarea>
                        <script>
                            ClassicEditor
                                .create(document.querySelector(' #texto')).catch(error => {
                                    console.error(error);
                                });
                        </script>
                        <br>
